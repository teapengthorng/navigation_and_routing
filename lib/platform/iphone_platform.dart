...
class IphonePlatform extends StatefulWidget {
  @override
  _IphonePlatformState createState() => _IphonePlatformState();
}

class _IphonePlatformState extends State<IphonePlatform> {
          ...
          child: PageIndicatorContainer(
            ...
            child: PageView(
              children: [
                ...
                Container(
                  child: Center(child: Text("Iphone", style: TextStyle(color: Colors.white, fontSize: 30),)),
                )
              ],
